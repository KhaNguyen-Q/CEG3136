...
static I2C_Xfer_t PadInit = {&LeafyI2C, 0x5A, txInit, 2, 1, 0, NULL};
...
static I2C_Xfer_t PadRdAddr = {&LeafyI2C, 0x5A txRdAddr, 1, 0, 0, NULL};
static I2C_Xfer_t PadRdData = {&LeafyI2C, 0x5A, rxRdData, 2, 1, 0, NULL};
